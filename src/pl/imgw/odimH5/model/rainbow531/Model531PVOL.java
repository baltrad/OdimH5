...
public class Model531PVOL {
    ...
    public static String createDescriptor(String fileNameOut, byte[] fileBuff,
            boolean verbose, Model531 rb, RadarOptions[] options) {
        ...
        nodeList = rb.getRAINBOWNodesByName(inputDoc, "sensorinfo", verbose);
        ...
        cont.setLon(rb.getRAINBOWMetadataElement(nodeList, "", verbose));

        nodeList = rb.getRAINBOWNodesByName(inputDoc, "lat", verbose);
        cont.setLat(rb.getRAINBOWMetadataElement(nodeList, "", verbose));

        nodeList = rb.getRAINBOWNodesByName(inputDoc, "alt", verbose);
        cont.setAlt(rb.getRAINBOWMetadataElement(nodeList, "", verbose));
...
//        System.out.println("hdf ma nazwe: " + fileNameOut);
    ...
    private static void makeXML(Model531 rb, boolean verbose,
    ...
    private static void makeH5(Model531 rb, boolean verbose,
            ParametersContainer cnt, String fileName) {
